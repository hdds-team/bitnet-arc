              ...
              unsigned       timed)
{
    ...
    /* --- v2 pass --- *
     *
     * XMX-accelerated path (design v2, brief docs/design-v2-phase-1.md
     * ratified e76bc98). Same shape, same input device buffers, same
     * correctness check. v2 variants report mode="BRANCHLESS" (v2 is
     * BRANCHLESS-only by design); the K_CHUNK is encoded in the
     * variant name (suffix "_k<KC>"). Phase 1 ships a single registered
     * variant (16x16/sg16/k256); Phase 2 will sweep wider tiles.
     */
